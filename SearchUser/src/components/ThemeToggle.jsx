...
const ThemeToggle = ({ toggleTheme, isDark }) => {
  return (
    <div className="flex justify-between items-center">
      ...
      <div
        className={`flex self-start px-[6px] py-[1px] gap-3 cursor-pointer group`}
        onClick={toggleTheme}
      >
        <span
          className={`font-bold text-[16px] tracking-[2.5px] transition-colors ${
            isDark
              ? "text-white group-hover:text-[#4b699b]"
              : "text-[#4b699b] group-hover:text-[#212630]"
          }`}
        >
          {isDark ? "LIGHT" : "DARK"}
        </span>
        ...
        {isDark ? (
          <svg
            ...
            width="20"
            height="20"
            className="transition-colors fill-white group-hover:fill-[#4b699b]"
          >
          ...
          <svg
            ...
            width="20"
            height="20"
            className="transition-colors fill-[#697C9A] group-hover:fill-[#212630]"
          >
